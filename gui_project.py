...
#    Jan 28, 2020 04:35:45 PM +0200  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.geometry("973x754+359+163")
        top.minsize(148, 1)
        top.maxsize(1924, 1055)
        top.resizable(1, 1)
        top.title("Control Page")
        ...
        photo_location = os.path.join(prog_location,"../Users/yuval/Desktop/BigProject/images/Lock1.jpg")
        global _img0
        ...
        photo_location = os.path.join(prog_location,"../Users/yuval/Desktop/BigProject/images/Unlock1.jpg")
        global _img1
        ...
        photo_location = os.path.join(prog_location,"../BigProject/images/start_transfer.png")
        global _img2
        ...
        photo_location = os.path.join(prog_location,"../Users/yuval/Desktop/BigProject/images/stop_transfer.png")
        global _img3
        ...
        photo_location = os.path.join(prog_location,"../Users/yuval/Desktop/BigProject/images/turn_on1.png")
        global _img4
        ...
        photo_location = os.path.join(prog_location,"../BigProject/images/turn_off1.png")
        global _img5
        ...
        photo_location = os.path.join(prog_location,"../Users/yuval/Desktop/BigProject/images/send_file.png")
        global _img6
        ...
        photo_location = os.path.join(prog_location,"../Users/yuval/Desktop/BigProject/images/watch_screen.png")
        global _img7
        ...
        self.Update_List = tk.Button(self.Frame_Features)
        self.Update_List.place(relx=0.524, rely=0.639, height=53, width=196)
        self.Update_List.configure(activebackground="#ececec")
        self.Update_List.configure(activeforeground="#000000")
        self.Update_List.configure(background="#83b4fc")
        self.Update_List.configure(cursor="hand2")
        self.Update_List.configure(disabledforeground="#a3a3a3")
        self.Update_List.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.Update_List.configure(foreground="#000080")
        self.Update_List.configure(highlightbackground="#d9d9d9")
        self.Update_List.configure(highlightcolor="black")
        self.Update_List.configure(pady="0")
        self.Update_List.configure(text='''Update List''')
        self.Update_List.bind('<Button-1>',lambda e:gui_project_support.update_client_list(e))
