...
#    May 11, 2020 04:15:11 PM +0300  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Clients_List.configure(font=font11)
        ...
        self.Select_All.place(relx=0.524, rely=0.531, height=53, width=206)
        ...
        self.Select_All.configure(font=font10)
        ...
        self.Select_All.bind('<Enter>',lambda e:gui_project_support.over_on(e, "Select_All"))
        self.Select_All.bind('<Leave>',lambda e:gui_project_support.over_off(e, "Select_All"))

        self.Clear_Selection = tk.Button(self.Frame_Features)
        self.Clear_Selection.place(relx=0.524, rely=0.639, height=53, width=206)
        ...
        self.Clear_Selection.configure(font=font10)
        ...
        self.Clear_Selection.bind('<Enter>',lambda e:gui_project_support.over_on(e, "Clear"))
        self.Clear_Selection.bind('<Leave>',lambda e:gui_project_support.over_off(e, "Clear"))
